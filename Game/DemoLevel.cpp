...
namespace STL
{
	...
	void DemoLevel::Initialize(ID3D11Device* device, Application* engine)
	{
		...
		soldierActor->SetPosition(0.0f, 0.0f, 0.0f);
		soldierActor->SetScale(0.25f, 0.25f, 0.25f);
		...
		squidGameActor->SetPosition(-50.0f, 0.0f, 50.0f);
		squidGameActor->SetRotation(0.0f, -45.0f, 0.0f);
		...
		squidGameMat3->AddTexture(new Texture(L"PinkSoldier_BaseColor_1011.png"));
		squidGameMat3->AddTexture(new Texture(L"PinkSoldier_BaseColor_1011.png"));
		squidGameMat3->AddTexture(new Texture(L"PinkSoldier_Normal_1011.png"));
		...
		squidGameActor2->SetPosition(50.0f, 0.0f, -50.0f);
		squidGameActor2->SetRotation(0.0f, 135.0f, 0.0f);
		...
		squidGameActor3->SetPosition(-50.0f, 0.0f, -50.0f);
		squidGameActor3->SetRotation(0.0f, -135.0f, 0.0f);
		...
		squidGameMat7->AddTexture(new Texture(L"PinkSoldier_BaseColor_1021.png"));
		squidGameMat7->AddTexture(new Texture(L"PinkSoldier_BaseColor_1021.png"));
		squidGameMat7->AddTexture(new Texture(L"PinkSoldier_Normal_1021.png"));
		...
		squidGameMat8->SetRimLightColor({ 1.0f, 0.0f, 1.0f });
		...
		squidGameActor4->SetPosition(50.0f, 0.0f, 50.0f);
		squidGameActor4->SetRotation(0.0f, 45.0f, 0.0f);
		...
		cubemapMaterial->AddTexture(new Texture(TEXT("Bridge2.dds")));
